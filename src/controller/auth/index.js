import { createUser, getUserByEmail, loginUser } from "../../service/user/index.js";
import { generateJWTToken, verifyPassword } from "../../utils/auth.js";
import { httpError } from "../../utils/httpError.js";

//this is for the signup
const signupController = async (req, res, next) => {
    const { name, email, password, type } = req.body; // Destructuring
...
export { signupController, loginController } //named exports
